...
\begin{table}
	...
	\resizebox{\linewidth}{!}{%
		\begin{tabular}{|l|l|l|l|}
			...
			LineageOS (GMS) & IMEI, serial number & Extensive list & Reduced\\
			LineageOS (microG) & -- & -- & --\\
