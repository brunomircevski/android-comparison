...
Most detailed payload observations came from Android 14; exact per-finding versions are unavailable. Failed Frida unpinning prevented Android 16 confirmation, so they provide prior-version context. GrapheneOS blocked instrumentation, leaving request contents unknown; Takeout instead shows a falsified serial, no IMEI, and four listed applications.
