...
\begin{figure}
	...
	\caption{Domains contacted in Scenario A1 aggregated for all tasks, grouped by operating system and by Google-related and other endpoints. Bubble size represents the total number of packets exchanged with each group. Vanilla LineageOS omitted due to lack of available scenarios} \label{fig-domains-chart}
\end{figure}
