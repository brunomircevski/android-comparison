...
iod\'eOS (7.0-20251129-bluejay, BP2A.250805.005).
...
To enable consistent and comparable measurements across Android distributions, four scenarios were defined. Scenarios were adapted to each system's capabilities (or skipped if not applicable). As a general principle, any required configuration step not available during initial setup was performed as soon as possible thereafter.
